...
<nav>
    <ul>
        <li><a href="staff_manage.php">Staff Management</a></li>
        <li><a href="stock_manage.php">Stock Management</a></li>
		<li><a href="item_manage.php">Items</a></li>
		<li><a href="customer_manage.php">Customer Management</a></li>
...
<footer>
    <p>&copy; <?php echo date("2024"); ?> Doner King. All rights reserved.</p>
</footer>
